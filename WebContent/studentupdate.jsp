...
<link rel="stylesheet"
    ...
    function validateForm() {
    	  ...
    	  if (x.startsWith("RA")==false||x.length!=15) {
...
<body>
      ...
      <div class="container">
        ...
        <form name="myform" onsubmit="return validateForm()" action="supdate" method="post">
          <div class="data">
            <label>UserId</label>
            <input type="text" name="uid" value="${stud.sid}" required>
          </div>
          <div class="data">
            <label>Email</label>
